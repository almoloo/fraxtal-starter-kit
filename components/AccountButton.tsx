					...
					<SheetContent className="flex flex-col">
						...
						<nav className="flex grow flex-col gap-3 overflow-y-auto">
							<MenuItem
								title="Home"
								icon={
									<HouseIcon className="h-5 w-5 text-neutral-500" />
								}
								href="/"
							/>
							...
							<MenuItem
								title="Call a method"
								icon={
									<ParenthesesIcon className="h-5 w-5 text-neutral-500" />
								}
							...
							<MenuItem
								title="Get data"
								icon={
									<BracesIcon className="h-5 w-5 text-neutral-500" />
								}
							...
							<MenuItem
								...
								icon={
									<DownloadIcon className="h-5 w-5 text-neutral-500" />
								}
								href="/ipfs/fetch"
							/>
							<MenuItem
							...
							<MenuItem
								...
								icon={
									<GlobeIcon className="h-5 w-5 text-neutral-500" />
								}
								href="/explorer"
							/>
						</nav>
				...
				<Dialog>
					...
					<DialogContent>
						<DialogHeader>
							...
							<DialogDescription>
								Connect your wallet to access the full
